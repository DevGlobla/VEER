...
elseif UserID == 1056550431 or UserID == 190175311  then  
...
if UserID == 1056550431 or UserID == 190175311 then return sendMsg(msg.chat_id_,msg.id_,"⌔︙ لا يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
...
📮┇[ لـ تواصل مع المطور](https://t.me/Yrlbot) 
]]
end
