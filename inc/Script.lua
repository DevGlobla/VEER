...
if text == "all" or text == "@all" and Admin(msg) then
if not redis:get(veer..'lock:tag:all'..msg.chat_id_) then
if redis:get(veer.."tag:all"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
redis:setex(veer..'tag:all'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if UserID == 1056550431 or UserID == 266057334 then return sendMsg(msg.chat_id_,msg.id_,"⌔︙ لا يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
