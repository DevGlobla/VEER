...
if msg.Director 
and (redis:get(veer..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(veer..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(veer..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(veer..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)) and MsgText[1] ~= "الغاء" then 
return false end 
...
if not msg.SudoUser then return '⌔︙لتفعيل حماية بوت سبارتا \n⌔︙عليك مراسلة مطور البوت @yybyy'end
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(veer..'group:add'..msg.chat_id_) then return sendMsg(msg.chat_id_,msg.id_,'⌔︙ المجموعه بالتأكيد تم تعطيلها \n⌔︙ بواسطه ←'..NameUser..' \n') end  
...
local edited = (redis:get(veer..':edited:'..arg.chat_id_..':'..arg.sender_user_id_) or 0)
...
local KleshaID = '⌔︙ '..Description..'\n⌔︙ ايديــك ← {'..arg.sender_user_id_..'} \n'..arg.UserNameID..'⌔︙ رتبتـــك ← '..arg.TheRank..' \n'..'⌔︙ تفاعـلك ← '..Get_Ttl(arg.msgs)..'\n'..'⌔︙ رسائلك ← {'..arg.msgs..'}\n⌔︙ سحكاتك ← {'..edited..'}'..' \n⌔︙ نقاطك ←('..nko..')'..' \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'
local Kleshaidinfo = redis:get(veer..":infoiduser_public:"..arg.chat_id_) or redis:get(veer..":infoiduser")  

if Kleshaidinfo then 
local points = redis:get(veer..':User_Points:'..arg.chat_id_..arg.sender_user_id_) or 0
...
KleshaID = KleshaID:gsub("#auto",Get_Ttl(arg.msgs))
KleshaID = KleshaID:gsub("#msgs",arg.msgs)
KleshaID = KleshaID:gsub("#edit",edited)
KleshaID = KleshaID:gsub("#game",points)
KleshaID = KleshaID:gsub("#Description",Description)
KleshaID = KleshaID:gsub("#bot",redis:get(veer..':NameBot:'))
KleshaID = KleshaID:gsub("#sudo",SUDO_USER)
end
if redis:get(veer.."idphoto"..msg.chat_id_) then
...
if not data.id_ then return sendMsg(arg.ChatID,arg.MsgID,"⌔︙ لا يوجد عضـو بهذا المـعرف ") end 
...
local numvv = redis:get(veer..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
return "- عدد سحكاتك هو : "..numvv
end


if MsgText[1] == "تغير الرتبه" then
if not msg.SuperCreator  then return "هذا الامر يخص المنشئين الاساسيين فما فوق فقط" end
redis:setex(veer..":Witing_NewRtba:"..msg.chat_id_..msg.sender_user_id_,1000,true)
redis:del(veer..":Witting_NewRtba2:"..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SuperCreator  then return "هذا الامر يخص المنشئين الاساسيين فما فوق فقط" end
redis:setex(veer..":Witing_DelNewRtba:"..msg.chat_id_..msg.sender_user_id_,1000,true)
return "- ارسل الرتبه المراد حذفها :\n\n• مطور اساسي \n• مطور \n• منشئ اساسي \n• منشئ \n• مدير \n• ادمن \n• مميز \n"
end
if MsgText[1] == "مسح قائمه الرتب" then
if not msg.SudoUser then return "⌔︙ هذا الامر يخص #sudo فقط  " end
redis:del(veer..":RtbaNew1:"..msg.chat_id_)
redis:del(veer..":RtbaNew2:"..msg.chat_id_)
redis:del(veer..":RtbaNew3:"..msg.chat_id_)
redis:del(veer..":RtbaNew4:"..msg.chat_id_)
redis:del(veer..":RtbaNew5:"..msg.chat_id_)
redis:del(veer..":RtbaNew6:"..msg.chat_id_)
redis:del(veer..":RtbaNew7:"..msg.chat_id_)
...
local Rtba1 = redis:get(veer..":RtbaNew1:"..msg.chat_id_) or " لايوجد "
local Rtba2 = redis:get(veer..":RtbaNew2:"..msg.chat_id_) or " لايوجد "
local Rtba3 = redis:get(veer..":RtbaNew3:"..msg.chat_id_) or " لايوجد "
local Rtba4 = redis:get(veer..":RtbaNew4:"..msg.chat_id_) or " لايوجد "
local Rtba5 = redis:get(veer..":RtbaNew5:"..msg.chat_id_) or " لايوجد "
local Rtba6 = redis:get(veer..":RtbaNew6:"..msg.chat_id_) or " لايوجد "
local Rtba7 = redis:get(veer..":RtbaNew7:"..msg.chat_id_) or " لايوجد "
...
message = ""
local monsha = redis:smembers(veer..':MONSHA_Group:'..msg.chat_id_)
if #monsha == 0 then 
...
if not msg.Admin then return "هذا الامر يخص الادمنيه فما فوق فقط" end
...
sendMsg(arg.ChatID,arg.MsgID,"⌔︙ تم تثبيت الرساله")
...
if data.ID == "Ok" then
sendMsg(arg.ChatID,arg.MsgID,"⌔︙ تم الغاء تثبيت الرساله ")    
elseif data.ID == "Error" and data.code_ == 6 then
...
elseif UserID == 1056550431 or UserID == 266057334  then  
...
elseif redis:sismember(veer..':MONSHA_Group:'..arg.ChatID,UserID) then 
...
elseif  redis:sismember(veer..'whitelist:'..arg.ChatID,UserID) then 
...
redis:set(veer..":TqeedUser:"..arg.ChatID..arg.UserID,true)
...
elseif redis:sismember(veer..':MONSHA_BOT:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ لا يمكنك تقييد المنشئ") 
elseif redis:sismember(veer..':MONSHA_Group:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ لا يمكنك نقييد المنشئ الاساسي") 
elseif redis:sismember(veer..'owners:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ لا يمكنك تقييد المدير") 
elseif redis:sismember(veer..'admins:'..msg.chat_id_,UserID) then 
...
redis:del(veer..":TqeedUser:"..arg.ChatID..UserID)
GetUserID(UserID,function(arg,data)
NameUser = Hyper_Link_Name(data)
...
redis:del(veer..":TqeedUser:"..arg.ChatID..arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"⌔︙ العضو  ←"..NameUser.." \n⌔︙ تم فك تقييده  من المجموعه") 
...
redis:hset(veer..'username:'..arg.UserID,'username',ReUsername)
...
if not msg.Creator then return "هذا الامر يخص المنشئين فما فوق فقط" end
if not MsgText[2] and msg.reply_id then
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"⌔︙ عذرا هذا العضو ليس موجود ضمن المجموعات ") end
local UserID = data.sender_user_id_
...
if not msg.SuperCreator then return "هذا الامر يخص المطورين فما فوق فقط" end
if not MsgText[2] and msg.reply_id then
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"⌔︙ عذرا هذا العضو ليس موجود ضمن المجموعات ") end
local UserID = data.sender_user_id_
...
if not msg.Director then return "هذا الامر يخص المدراء فما فوق فقط" end
if not MsgText[2] and msg.reply_id then
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"⌔︙ عذرا هذا العضو ليس موجود ضمن المجموعات ") end
local UserID = data.sender_user_id_
...
local edited = redis:get(veer..':edited:'..arg.ChatID..':'..arg.UserID) or 0
local content = redis:get(veer..':adduser:'..arg.ChatID..':'..arg.UserID) or 0
...
NameUser = Hyper_Link_Name(data)
local maseegs = redis:get(veer..'msgs:'..UserID..':'..arg.ChatID) or 1
local edited = redis:get(veer..':edited:'..arg.ChatID..':'..UserID) or 0
local content = redis:get(veer..':adduser:'..arg.ChatID..':'..UserID) or 0
...
if UserID == our_id then return sendMsg(arg.ChatID,arg.MsgID,"⌔︙ لا يمكنك تنفيذ الامر بالرد ع رسالة البوت ") end
GetUserID(UserID,function(arg,data)
if msg.SudoBase then redis:srem(veer..'gban_users',arg.UserID)  end 
Restrict(arg.ChatID,arg.UserID,2)
...
local UserID = data.id_
if UserID == our_id then return sendMsg(arg.ChatID,arg.MsgID,"⌔︙ لا يمكنك تنفيذ الامر بالرد ع رسالة البوت ") end
if msg.SudoBase then redis:srem(veer..'gban_users',UserID)  end 
Restrict(arg.ChatID,UserID,2)
...
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
if msg.SudoBase then redis:srem(veer..'gban_users',MsgText[2])  end 
...
if not msg.Admin then return "هذا الامر يخص الادمنيه فما فوق فقط" end
if not msg.Creator and not redis:get(veer.."lock_KickBan"..msg.chat_id_) then return "⌔︙ الامر معطل من قبل اداره المجموعة  " end
...
NameUser = Hyper_Link_Name(data)
USERNAME = ResolveUserName(data)
if redis:sismember(veer..'banned:'..arg.ChatID,arg.UserID) then 
...
if not msg.SuperCreator then return "هذا الامر يخص المنشئين فما فوق فقط" end
...
NameUser = Hyper_Link_Name(data)
if data.type_.ID == "ChannelChatInfo" then return sendMsg(arg.ChatID,arg.MsgID,"⌔︙ عذرا هذا معرف قناة وليس حساب ") end
redis:hset(veer..'username:'..UserID,'username',arg.USERNAME)
redis:setex(veer..":uploadingsomeon:"..arg.ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(veer..":uploadingsomeon2:"..arg.ChatID..msg.sender_user_id_,500,UserID)
sendMsg(arg.ChatID,arg.MsgID,"⌔︙  » حسننا الان ارسل صلاحيات المشرف :\n\n︙1- صلاحيه تغيير المعلومات\n︙2- صلاحيه حذف الرسائل\n︙3- صلاحيه دعوه مستخدمين\n︙4- صلاحيه حظر وتقيد العضوين \n︙5- صلاحيه تثبيت الرسائل \n︙6- صلاحيه رفع مشرفين اخرين\n\n︙[*]- لرفع كل الصلاحيات ما عدا رفع المشرفين \n︙[**] - لرفع كل الصلاحيات مع رفع المشرفين \n\n⌔︙ يمكنك اختيار الارقام معا وتعيين الكنيه للمشرف في ان واحد مثلا : \n\n︙ 136 سبارتا") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,USERNAME=MsgText[2]})
...
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"⌔︙ عذرا هذا العضو ليس موجود ضمن المجموعات ") end
local UserID = data.sender_user_id_
if UserID == our_id then return sendMsg(arg.ChatID,arg.MsgID,"⌔︙ لا يمكنك استخدام الامر بالرد على البوت") end
GetUserID(UserID,function(arg,data)
USERNAME = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
...
GetUserName(MsgText[2],function(arg,data)
if not data.id_ then return sendMsg(arg.ChatID,arg.MsgID,"⌔︙ لا يوجد عضـو بهذا المـعرف ") end 
if data.id_ == our_id then return sendMsg(arg.ChatID,arg.MsgID,"⌔︙ لا يمكنك تنفيذ الامر مع البوت ") end 
local UserID = data.id_
UserName = arg.UserName
NameUser = Hyper_Link_Name(data)
...
elseif UserID == SUDO_ID then 
return sendMsg(arg.ChatID,arg.MsgID,"⌔︙ لا يمكنك كتم4 الاساسي\n🛠") 
elseif UserID == 1056550431 or UserID == 266057334 then 
return sendMsg(arg.ChatID,arg.MsgID,"⌔︙ لا يمكنك كتم مطور السورس\n🛠") 
elseif redis:sismember(veer..':SUDO_BOT:',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⌔︙ لا يمكنك كتم4\n🛠") 
elseif redis:sismember(veer..':MONSHA_BOT:'..arg.ChatID,UserID) then 
...
if not msg.Creator  then return "هذا الامر يخص المنشئين فما فوق فقط" end 
redis:setex(veer..'WiCmdLink'..msg.chat_id_..msg.sender_user_id_,500,true)
return '⌔︙ الان ارسل  رابط مجموعتك '
end
...
if not redis:get(veer.."lock_linkk"..msg.chat_id_) then return "⌔︙ الامر معطل من قبل الادارة \n^"  end
if not redis:get(veer..'linkGroup'..msg.chat_id_) then return "⌔︙ لا يــوجد رابط\n⌔︙لانشاء رابط ارسل { انشاء رابط }" end
...
if not msg.Admin then return "هذا الامر يخص الادمنيه فما فوق فقط" end
redis:setex(veer..'rulse:witting'..msg.chat_id_..msg.sender_user_id_,300,true)
return '⌔︙ الان ارسل القوانين  للمجموعه'
end
...
redis:set(veer..'num_msg_max'..msg.chat_id_,MsgText[2]) 
return "⌔︙ تم وضع التكرار » { *"..MsgText[2].."* }"
end

if MsgText[1] == "ضع وقت التنظيف" then
if not msg.Creator then return "هذا الامر يخص المدراء فما فوق فقط" end
local NumLoop = tonumber(MsgText[2])
redis:set(veer..':Timer_Cleaner:'..msg.chat_id_,NumLoop) 
...
local Admins = redis:scard(veer..':MONSHA_Group:'..msg.chat_id_)
if Admins == 0 then  
return "⌔︙ عذرا لا يوجد منشئيين اساسييين ليتم مسحهم " 
end
redis:del(veer..':MONSHA_Group:'..msg.chat_id_)
...
if not msg.Creator then return "هذا الامر يخص المنشئين فما فوق فقط" end
local mmezz = redis:smembers(veer..":IdsMsgsCleaner:"..msg.chat_id_)
...
redis:del(veer..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
...
if not msg.SuperCreator    then return "⌔︙ هذا الامر يخص {المطور,منشئ الاساسي} فقط  " end
...
if not msg.Admin then return "هذا الامر يخص الادمنيه فما فوق فقط" end
redis:setex(veer..'name:witting'..msg.chat_id_..msg.sender_user_id_,300,true)
return "︙ الان ارسل الاسم  للمجموعه "
end
...
sendMsg(arg.ChatID,arg.MsgID,'⌔︙ تم حذف صوره المـجمـوعه ')
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
return false
end
...
return '⌔︙ الان قم بارسال الصوره' 
end 
end

if MsgText[1] == "ضع وصف" then 
if not msg.Admin then return "هذا الامر يخص الادمنيه فما فوق فقط" end
redis:setex(veer..'about:witting'..msg.chat_id_..msg.sender_user_id_,300,true) 
return "︙ الان ارسل الوصف  للمجموعه" 
end

if MsgText[1] == "الادارين" or MsgText[1] == "الأداريين" or MsgText[1] == "الاداريين" or MsgText[1] == "الادارين" then   
if not msg.Admin then return "هذا الامر يخص الادمنيه فما فوق فقط" end
if not redis:get(veer.."lock_takkl"..msg.chat_id_) then  return "⌔︙ الامر معطل من قبل الادراة" end 
if redis:get(veer.."chat:tagall"..msg.chat_id_) then  return "⌔︙ يمكنك عمل تاك للكل كل *5 دقائق* فقط" end 
redis:setex(veer..'chat:tagall'..msg.chat_id_,300,true)
return TagAll(msg) 
end
...
if redis:sismember(veer..':Filter_Word:'..arg.ChatID,Type_id) then 
return sendMsg(arg.ChatID,arg.MsgID,"⌔︙ هي بالتأكيد في قائمه المنع")
else
redis:sadd(veer..':Filter_Word:'..arg.ChatID,Type_id) 
...
if redis:sismember(veer..':Filter_Word:'..arg.ChatID,Type_id) then 
redis:srem(veer..':Filter_Word:'..arg.ChatID,Type_id) 
...
if not msg.Creator  then return "⌔︙ هذا الامر يخص {المطور ,المنشئ الاساسي ,المنشئ } فقط  " end
return conslist(msg)
end
...
if not msg.Director then return "هذا الامر يخص المنشئين فما فوق فقط" end
...
TextR = TextR.."⌔︙ لم يتم طـرد {* "..NumBotAdmin.." *} بوت لانه‌‏م مـشـرفين."
else
...
return '⌔︙  عدد جهاتك المـضـافه » 【'..(redis:get(veer..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..'】 . '
end
...
if data.username_ then USERNAME = "⌔︙ المعرف ← @["..data.username_.."] ." end 
...
if MsgText[1] == "تفعيل الردود" 		then return unlock_rdodSource(msg) end 
...
if MsgText[1] == "تعطيل الردود" 		then return lock_rdodSource(msg) end 


if MsgText[1] == "ضع الترحيب" then 
if not msg.Admin then return "هذا الامر يخص الادمنيه فما فوق فقط" end
redis:set(veer..'welcom:witting'..msg.chat_id_..msg.sender_user_id_,true) 
return "⌔︙ حسننا عزيزي  ✋🏿\n⌔︙ ارسل كليشه الترحيب الان\n\n علما ان الاختصارات كالاتي : \n \n#name : لوضع اسم العضو\n#id : لوضع ايدي العضو\n#username : لوضع معرف العضو \n#stast : لوضع نوع رتبه العضو \n#auto : لوضع تفاعل العضو \n#msgs : لاضهار عدد الرسائل \n#game : لاضهار عدد النقاط \n#edit : لاضهار عدد السحكات \n#bot : لاضهار اسم البوت\n#sudo : لاضهار معرف المطور الاساسي\n➼" 
end
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(veer..':MONSHA_Group:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"⌔︙ العضو  ←"..NameUser.." \n⌔︙ تم بالتأكيد رفعه منشئ اساسي  في المجموعه") 
else
sendMsg(arg.ChatID,arg.MsgID,"⌔︙ العضو  ←"..NameUser.." \n⌔︙ تم رفعه منشئ اساسي  في المجموعه") 
redis:hset(veer..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(veer..':MONSHA_Group:'..arg.ChatID,arg.UserID)
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
local UserID = data.id_
NameUser = Hyper_Link_Name(data)
if redis:sismember(veer..':MONSHA_Group:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"⌔︙ العضو  ←"..NameUser.." \n⌔︙ تم بالتأكيد رفعه منشئ اساسي  في المجموعه") 
else
redis:hset(veer..'username:'..UserID,'username',arg.UserName)
redis:sadd(veer..':MONSHA_Group:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"⌔︙ العضو  ←"..NameUser.." \n⌔︙ تم رفعه منشئ اساسي  في المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
if not redis:sismember(veer..':MONSHA_Group:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"⌔︙ العضو  ←"..NameUser.." \n⌔︙ تم بالتأكيد تنزيله منشئ اساسي  في المجموعه") 
else
sendMsg(arg.ChatID,arg.MsgID,"⌔︙ العضو  ←"..NameUser.." \n⌔︙ تم تنزيله منشئ اساسي  في المجموعه") 
redis:srem(veer..':MONSHA_Group:'..arg.ChatID,arg.UserID)
end  
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
UserName = Flter_Markdown(arg.UserName)
NameUser = Hyper_Link_Name(data)
if not redis:sismember(veer..':MONSHA_Group:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"⌔︙ العضو  ←"..NameUser.." \n⌔︙ تم بالتأكيد تنزيله منشئ اساسي  في المجموعه") 
else
redis:srem(veer..':MONSHA_Group:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"⌔︙ العضو  ←"..NameUser.." \n⌔︙ تم تنزيله منشئ اساسي  في المجموعه")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
if not msg.SudoBase then return "⌔︙ هذا الامر يخص {مطور اساسي} فقط  " end
redis:del(veer..":awamer_Klesha_m1:")
redis:del(veer..":awamer_Klesha_m2:")
redis:del(veer..":awamer_Klesha_m3:")
redis:del(veer..":awamer_Klesha_mtwr:")
redis:del(veer..":awamer_Klesha_mrd:")
redis:del(veer..":awamer_Klesha_mf:")
redis:del(veer..":awamer_Klesha_m:")
...
redis:del(veer..":infoiduser_public:"..msg.chat_id_)
...
if not msg.Creator then return "⌔︙ هذا الامر يخص {منشئ اساسي,المنشئ,المطور} فقط  " end
redis:setex(veer..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_,1000,true)
return '⌔︙ حسننا , الان ارسل كليشه الايدي الجديده \n علما ان الاختصارات كالاتي : \n \n#name : لوضع اسم العضو\n#id : لوضع ايدي العضو\n#username : لوضع معرف العضو \n#stast : لوضع نوع رتبه العضو \n#auto : لوضع تفاعل العضو \n#msgs : لاضهار عدد الرسائل \n#game : لاضهار عدد النقاط \n#edit : لاضهار عدد السحكات \n#bot : لاضهار اسم البوت\n#sudo : لاضهار معرف المطور الاساسي\n قناه تعليمات ونشر كلايش الايدي \n قناه الكلايش : [@GLOBLA_id] ' 
end
...
if UserID == 1056550431 or UserID == 266057334 then return sendMsg(msg.chat_id_,msg.id_,"⌔︙ لا يمكنك تنفيذ الامر ضد مطور السورس ") end
...
elseif redis:sismember(veer..'admins:'..msg.chat_id_,UserID) then 
rinkuser = 6
elseif redis:sismember(veer..'whitelist:'..msg.chat_id_,UserID) then 
rinkuser = 7
else
rinkuser = 8
end
...
if redis:sismember(veer..':MONSHA_Group:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."⌔︙ تم تنزيله من المنشئ الاساسي ✓️\n"
end 
if redis:sismember(veer..':MONSHA_BOT:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."⌔︙ تم تنزيله من المنشئ ✓️\n"
end 
if redis:sismember(veer..'owners:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."⌔︙ تم تنزيله من المدير ✓️\n"
end 
if redis:sismember(veer..'admins:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."⌔︙ تم تنزيله من الادمن ✓️\n"
end 
if redis:sismember(veer..'whitelist:'..msg.chat_id_,UserID) then
DonisDown = DonisDown.."⌔︙ تم تنزيله من العضو مميز ✓️\n"
end
function senddwon() sendMsg(msg.chat_id_,msg.id_,"⌔︙ عذرا العضو رتبته اعلى منك لا يمكن تنزيله ") end
...
redis:srem(veer..':MONSHA_Group:'..msg.chat_id_,UserID)
redis:srem(veer..':MONSHA_BOT:'..msg.chat_id_,UserID)
redis:srem(veer..'owners:'..msg.chat_id_,UserID)
redis:srem(veer..'admins:'..msg.chat_id_,UserID)
redis:srem(veer..'whitelist:'..msg.chat_id_,UserID)
...
if not data.id_ then return sendMsg(arg.ChatID,arg.MsgID,"⌔︙ لا يوجد عضـو بهذا المـعرف ") end 
local UserID = data.id_
if UserID == our_id then return sendMsg(arg.ChatID,arg.MsgID,"⌔︙ لا يمكنك تنفيذ الامر مع البوت") end
...
if not msg.Director then return "هذا الامر يخص المدراء فما فوق فقط" end
local list = redis:hgetall(veer..":AwamerBotArray2:"..msg.chat_id_)
local list2 = redis:hgetall(veer..":AwamerBotArray:"..msg.chat_id_)
...
if not msg.Director then return "هذا الامر يخص المدراء فما فوق فقط" end
local Awammer 	= redis:del(veer..":AwamerBot:"..msg.chat_id_)
redis:del(veer..":AwamerBotArray:"..msg.chat_id_)
redis:del(veer..":AwamerBotArray2:"..msg.chat_id_)
if Awammer ~= 0 then
...
for k, Veer in pairs(XVeer) do if MsgText[2]:match(Veer) then  checkAmr = true end end      
if checkAmr then
redis:setex(veer..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_,300,MsgText[2])
return "⌔︙ حسننا عزيزي , لتغير امر {* "..MsgText[2].." *}  ارسل الامر الجديد الان \n..."
else
return "⌔︙ عذرا لا يوجد هذا الامر في البوت لتتمكن من تغييره  \n"
end
else
redis:setex(veer..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Director then return "هذا الامر يخص المدراء فما فوق فقط" end
if MsgText[2] then
local checkk = redis:hdel(veer..":AwamerBotArray2:"..msg.chat_id_,MsgText[2])
local AmrOld = redis:hgetall(veer..":AwamerBotArray:"..msg.chat_id_)
amrnew = ""
amrold = ""
...
redis:hdel(veer..":AwamerBotArray:"..msg.chat_id_,Amor)
...
redis:setex(veer..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:setex(veer..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:setex(veer..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_,1000,true)
return '⌔︙ ارسل امر القائمه المراد تعيينهم مثل الاتي "\n︙`الاوامر` , `م1` , `م2 `, `م3 `, `م4 ` , `م5 `,  `اوامر الملفات` ' 
end
...
redis:hset(veer..'username:'..arg.UserID,'username',RUSERNAME)
...
redis:hset(veer..'username:'..UserID,'username',ReUsername)
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[⌔︙ مـرحبا انا بوت اسـمـي ]]..redis:get(veer..':NameBot:')..[[ ⌔︙ اختصـاصـي حمـايه المـجمـوعات⌔︙ مـن السـبام والتوجيه والتكرار والخ...]]..SUDO_USERR) 
return false
else
...
return'⌔︙ شـرط التفعيل البوت اذا كانت المـجمـوعه اكثر مـن *【'..redis:get(veer..':addnumberusers')..'】* عضـو  \n' 
end 
end
...
if not msg.SudoUser then return "⌔︙ هذا الامر يخص #sudo فقط  " end
if not msg.SudoBase and not redis:get(veer.."lockidedit") then return "⌔︙ الامر معطل من قبل المطور الاساسي  " end
redis:del(veer..":infoiduser")
...
if not msg.SudoUser then return "⌔︙ هذا الامر يخص #sudo فقط  " end
if not msg.SudoBase and not redis:get(veer.."lockidedit") then return "⌔︙ تعيين الايدي معطل من قبل المطور الاساسي  " end
redis:setex(veer..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,1000,true)
return '⌔︙ حسننا , الان ارسل كليشه الايدي الجديده \n علما ان الاختصارات كالاتي : \n \n#name : لوضع اسم العضو\n#id : لوضع ايدي العضو\n#username : لوضع معرف العضو \n#stast : لوضع نوع رتبه العضو \n#auto : لوضع تفاعل العضو \n#msgs : لاضهار عدد الرسائل \n#game : لاضهار عدد النقاط \n#edit : لاضهار عدد السحكات \n#bot : لاضهار اسم البوت\n#sudo : لاضهار معرف المطور الاساسي\n قناه تعليمات ونشر كلايش الايدي \n قناه الكلايش : [@GLOBLA_id] ' 
end


if MsgText[1] == 'قائمه المجموعات' then 
if not msg.SudoBase then return "⌔︙ هذا الامر يخص #sudo فقط  " end
...
local name_gp = redis:get(veer..'group:name'..idgrup)
...
return send_msg(msg.chat_id_,redis:get(veer..":TEXT_SUDO") or SUDO_NAME,msg.id_)
end,nil)
end

if MsgText[1] == "اذاعه بالتثبيت"  or MsgText[1] =="اذاعه بالتثبيت 📬" then
if not msg.SudoUser then return"⌔︙ هذا الامر يخص #sudo فقط  " end
redis:setex(veer..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,300, true) 
...
if not msg.Admin then return "هذا الامر يخص الادمنيه فما فوق فقط" end
redis:del(veer..'welcom:witting'..msg.chat_id_..msg.sender_user_id_,
veer..'rulse:witting'..msg.chat_id_..msg.sender_user_id_,
veer..'name:witting'..msg.chat_id_..msg.sender_user_id_,
veer..'about:witting'..msg.chat_id_..msg.sender_user_id_,
...
veer..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,
veer..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_,
veer..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_,
veer..'addrd:'..msg.chat_id_..msg.sender_user_id_,
veer..':KStart:'..msg.chat_id_..msg.sender_user_id_,
veer.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_,
veer..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_,
veer..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_,
veer..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_,
veer..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_,
veer..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_,
veer..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_,
veer..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
veer..":ForceSub:"..msg.sender_user_id_,
veer..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,
veer..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_,
veer..'addrdRandom:'..msg.chat_id_..msg.sender_user_id_,
veer..'replay1Random'..msg.chat_id_..msg.sender_user_id_,
veer..'addrdRandom1:'..msg.sender_user_id_,
veer..'addrdRandom:'..msg.sender_user_id_,
veer..'replay1Random'..msg.sender_user_id_)
...
if not msg.SudoBase then return "هذا الامر يخص المطور الاساسي فقط  " end
local GetVerison = https.request('https://DevGlobla/GetVersion.txt') or "0"
...
sendMsg(arg.chat_id_,arg.id_,'⌔︙ عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس سبارتا يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم')
end  
else
...
local inline = {{{text="قناه السـورس : سبارتا 🍃",url="t.me/spirta"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : سبارتا](t.me/spirta)',nil,inline,msg.id_)
return false
end
...
if not msg.SudoBase then return"هذا الامر يخص المطور الاساسي فقط  " end
redis:setex(veer..':KStart:'..msg.chat_id_..msg.sender_user_id_,900,true)
...
local file 	= redis:exists(veer..'replay_files:group:'..msg.chat_id_)
...
veer..'replay_animation:group:'..msg.chat_id_,veer..'replay_audio:group:'..msg.chat_id_,veer..'replay_sticker:group:'..msg.chat_id_,veer..'replay_video:group:'..msg.chat_id_,veer..'replay_files:group:'..msg.chat_id_)
...
if not msg.SudoBase then return"هذا الامر يخص المطورين فقط" end
...
local file 	= redis:exists(veer..'replay_files:group:')
if names or photo or voice or imation or audio or sticker or video or file then
redis:del(veer..'replay:all',veer..'replay_photo:group:',veer..'replay_voice:group:',veer..'replay_animation:group:',veer..'replay_audio:group:',veer..'replay_sticker:group:',veer..'replay_video:group:',veer..'replay_files:group:')
return " تم مسح كل ردود المطور"
else
return "لا يوجد ردود للمطور ليتم مسحها"
end
end
...
local files 	= redis:hkeys(veer..'replay_files:group:'..msg.chat_id_)
...
if MsgText[1]== 'ردود المطور' or MsgText[1]=='ردود المطور 🗨' then
...
local files 	= redis:hkeys(veer..'replay_files:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 and #files==0 then 
return '⌔︙ لا يوجد ردود مضافه حاليا ' 
end
local ii = 1
...
if not msg.Director then return "هذا الامر يخص المدراء فما فوق فقط" end
redis:setex(veer..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_,1400,true) 
redis:del(veer..'replay1Random'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.Director then return "هذا الامر يخص المدراء فما فوق فقط" end
redis:setex(veer..':DelrdRandom:'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Director then return "هذا الامر يخص المدراء فما فوق فقط " end
local AlRdod = redis:smembers(veer..':KlmatRRandom:'..msg.chat_id_) 
if #AlRdod == 0 then return "⌔︙ الردود العشوائيه محذوفه بالفعل" end
for k,v in pairs(AlRdod) do redis:del(veer..':ReplayRandom:'..msg.chat_id_..":"..v) redis:del(veer..':caption_replay:Random:'..msg.chat_id_..v) 
end
redis:del(veer..':KlmatRRandom:'..msg.chat_id_) 
return "⌔︙ تم مسح جميع الردود العشوائيه"
end
...
local incrr = redis:scard(veer..':ReplayRandom:'..msg.chat_id_..":"..v) 
...
if not msg.SudoUser then return "⌔︙ هذا الامر يخص #sudo فقط  " end
redis:setex(veer..'addrdRandom1Public:'..msg.chat_id_..msg.sender_user_id_,1400,true) 
redis:del(veer..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoUser then return "⌔︙ هذا الامر يخص #sudo فقط  " end
redis:setex(veer..':DelrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_,300,true)
return "⌔︙ حسننا عزيزي  \n⌔︙ الان ارسل الرد العشوائي العام لمسحها "
end

if MsgText[1] == "مسح الردود العشوائيه العامه" then
if not msg.SudoUser then return "⌔︙ هذا الامر يخص #sudo فقط  " end
local AlRdod = redis:smembers(veer..':KlmatRRandom:') 
if #AlRdod == 0 then return "⌔︙ الردود العشوائيه محذوفه بالفعل" end
for k,v in pairs(AlRdod) do redis:del(veer..":ReplayRandom:"..v) redis:del(veer..':caption_replay:Random:'..v)  end
redis:del(veer..':KlmatRRandom:') 
return "⌔︙ تم مسح جميع الردود العشوائيه"
end
...
for k,v in pairs(AlRdod) do
local incrr = redis:scard(veer..":ReplayRandom:"..v) 
message = message..k..'- ['..v..'] ← ← {*'..incrr..'*} . رد\n'
end
end
return message.."\n"
...
echo '*------------------------------\n*💾l ← { وحـده الـتـخـزيـن } .\n*»» '"$HardDisk"'*'
echo '*------------------------------\n*⚙️l ← { الـمــعــالــج } .\n*»» '"`grep -c processor /proc/cpuinfo`""Core ~ {$CPUPer%} "'*'
echo '*------------------------------\n*📡l ← { موقـع الـسـيـرفـر } .\n*»» '`curl http://th3veer.com/ip/location`'*'
echo '*------------------------------\n*👨🏾‍🔧l ← { الــدخــول } .\n*»» '`whoami`'*'
...
if msg.SudoBase and (MsgText[1]=="م1" or MsgText[1]=="م2" or MsgText[1]=="م3" or MsgText[1]=="م4" or MsgText[1]=="م5" or MsgText[1]=="الاوامر" or MsgText[1]=="اوامر الملفات") and redis:get(veer..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(veer..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_)
redis:setex(veer..":changawmer:"..msg.chat_id_..msg.sender_user_id_,900,MsgText[1])
...
SUDO_USER = redis:hgetall(veer..'username:'..SUDO_ID).username
text = [[ 
⌔︙الاوامر العامة في البوت
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⌔︙ارسل { م1 } ← اوامر الإدارة 
⌔︙ارسل { م2 } ← اوامر المجموعة 
⌔︙ارسل { م3 } ← اوامر الحماية
⌔︙ارسل { م4 } ← اوامر المطور
⌔︙ارسل { م5 } ← اوامر الرد 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(veer..":awamer_Klesha_m:")
if textD then
...
⌔︙مسح الرابط 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⌔︙اوامر الطرد والحظر والكتم  ↓
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⌔︙حظر - طرد - كتم - تقييد 
⌔︙الغاء الحظر - الغاء الكتم 
⌔︙فك التقييد - رفع القيود 
⌔︙منع + الكلمه
⌔︙الغاء منع + الكلمه
⌔︙طرد البوتات
⌔︙طرد المحذوفين
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(veer..":awamer_Klesha_m1:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(veer..":awamer_Klesha_m2:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(veer..":awamer_Klesha_m3:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
⌔︙غادر + اسم البوت 
⌔︙اذاعه ، اذاعه بالتوجيه ، اذاعه بالتثبيت، اذاعه عام 
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(veer..":awamer_Klesha_mtwr:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
local text = [[ ☑️ اهلا بك في قائمة م5ود
📨 للاستفسار - []]..SUDO_USER..[[]
...
• مسح ردود المطور : لمسح كل ردود العامه ]]

GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(veer..":awamer_Klesha_mrd:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(veer..":awamer_Klesha_mf:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
if not redis:get(veer.."lock_leftgroup"..msg.chat_id_) then  return "⌔︙ امر المغادره معطل من قبل اداره المجموعة  " end
...
return [[
🌐┇[SpArTa BoT](t.me/spirta)

📻┇[ Instagram Tools bot](https://t.me/LA9BOT) 
🎧┇[ Youtube bot](https://t.me/Tubekbot) 

📮┇[ لـ تواصل مع المطور](https://t.me/yybyybot) 
]]
end

if MsgText[1] == "متجر الملفات" or MsgText[1]:lower() == "/store"  then
if not msg.SudoBase then return "هذا الامر يخص المطور الاساسي فقط  " end
local Get_Files, res = https.request("https://DevGlobla/File/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/DevGlobla/File/master/plugins/"..FileName)
if res == 200 then
...
text = [[⌔︙ مـرحبا انا بوت اسـمـي []]..redis:get(veer..':NameBot:')..[[] ⌔︙ اختصـاصـي حمـايه المـجمـوعات⌔︙ مـن السـبام والتوجيه والتكرار والخ...⌔︙ فقط المـطـور يسـتطـيع تفعيل البوت]]..SUDO_USERR..[[⌔]]
GetUserID(msg.sender_user_id_,function(arg,data)
if data.last_name_ then Name = data.first_name_ .." "..data.last_name_ else Name = data.first_name_ end
text = redis:get(veer..':Text_Start') or text
local edited = (redis:get(veer..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local points = redis:get(veer..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
local Emsgs = redis:get(veer..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end  
...
text = text:gsub("#bot",redis:get(veer..':NameBot:'))
text = text:gsub("#sudo",SUDO_USER)
...
if public then
redis:hset(veer..':caption_replay:Random:'..msg.klma,input,msg.content_.caption_) 
else
redis:hset(veer..':caption_replay:Random:'..msg.chat_id_..msg.klma,input,msg.content_.caption_) 
end
end
end

--====================== Reply Random Public =====================================
if redis:get(veer..'addrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_) and redis:get(veer..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_) then
klma = redis:get(veer..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_)
msg.klma = klma
if msg.text == "تم" then
redis:del(veer..'addrdRandom1Public:'..msg.chat_id_..msg.sender_user_id_)
redis:del(veer..'addrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_)
sendMsg(msg.chat_id_,msg.id_,'⌔︙ تم اضافه رد متعدد عشوائي بنجاح ✓\n⌔︙ يمكنك ارسال (['..klma..']) لاضهار الردود العشوائيه .')
redis:del(veer..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_)
return false
end

local CountRdod = redis:scard(veer..':ReplayRandom:'..klma) or 1
...
redis:sadd(veer..':KlmatRRandom:',klma) 
redis:sadd(veer..':ReplayRandom:'..klma,":Text:"..msg.text) 
...
redis:sadd(veer..':KlmatRRandom:',klma) 
redis:sadd(veer..':ReplayRandom:'..klma,":Photo:"..photo_id) 
...
elseif msg.content_.ID == "MessageVoice" then
redis:sadd(veer..':KlmatRRandom:',klma) 
redis:sadd(veer..':ReplayRandom:'..klma,":Voice:"..msg.content_.voice_.voice_.persistent_id_) 
...
elseif msg.content_.ID == "MessageAnimation" then
redis:sadd(veer..':KlmatRRandom:',klma) 
redis:sadd(veer..':ReplayRandom:'..klma,":Animation:"..msg.content_.animation_.animation_.persistent_id_) 
...
elseif msg.content_.ID == "MessageVideo" then
redis:sadd(veer..':KlmatRRandom:',klma) 
redis:sadd(veer..':ReplayRandom:'..klma,":Video:"..msg.content_.video_.video_.persistent_id_) 
...
elseif msg.content_.ID == "MessageAudio" then
redis:sadd(veer..':KlmatRRandom:',klma) 
redis:sadd(veer..':ReplayRandom:'..klma,":Audio:"..msg.content_.audio_.audio_.persistent_id_) 
...
redis:sadd(veer..':KlmatRRandom:',klma) 
redis:sadd(veer..':ReplayRandom:'..klma,":Document:"..msg.content_.document_.document_.persistent_id_) 
...
elseif msg.content_.ID == "MessageSticker" then
redis:sadd(veer..':KlmatRRandom:',klma) 
redis:sadd(veer..':ReplayRandom:'..klma,":Sticker:"..msg.content_.sticker_.sticker_.persistent_id_) 
...
if redis:get(veer..'addrdRandom:'..msg.chat_id_..msg.sender_user_id_) and redis:get(veer..'replay1Random'..msg.chat_id_..msg.sender_user_id_) then
klma = redis:get(veer..'replay1Random'..msg.chat_id_..msg.sender_user_id_)
msg.klma = klma
if msg.text == "تم" then
redis:del(veer..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_)
redis:del(veer..'addrdRandom:'..msg.chat_id_..msg.sender_user_id_)
sendMsg(msg.chat_id_,msg.id_,'⌔︙ تم اضافه رد متعدد عشوائي بنجاح ✓\n⌔︙ يمكنك ارسال (['..klma..']) لاضهار الردود العشوائيه .')
redis:del(veer..'replay1Random'..msg.chat_id_..msg.sender_user_id_)
return false
end

local CountRdod = redis:scard(veer..':ReplayRandom:'..msg.chat_id_..":"..klma) or 1
local CountRdod2 = 10 - tonumber(CountRdod)
local CountRdod = 9 - tonumber(CountRdod)
if CountRdod2 == 0 then 
redis:del(veer..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_)
...
redis:sadd(veer..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(veer..':ReplayRandom:'..msg.chat_id_..":"..klma,":Text:"..msg.text) 
return sendMsg(msg.chat_id_,msg.id_,'تم ادراج الرد باقي '..CountRdod..'\n تم ادراج الرد ارسل رد اخر او ارسل {تم} ')
elseif msg.content_.ID == "MessagePhoto" then
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
...
redis:sadd(veer..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(veer..':ReplayRandom:'..msg.chat_id_..":"..klma,":Photo:"..photo_id) 
CaptionInsert(msg,photo_id,false)
return sendMsg(msg.chat_id_,msg.id_,'🌃︙ تم ادراج صور للرد باقي '..CountRdod..' ✓\n🌃︙ ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageVoice" then
redis:sadd(veer..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(veer..':ReplayRandom:'..msg.chat_id_..":"..klma,":Voice:"..msg.content_.voice_.voice_.persistent_id_) 
CaptionInsert(msg,msg.content_.voice_.voice_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'🎤︙ تم ادراج البصمه للرد باقي '..CountRdod..' ✓\n🎤︙  ارسل رد اخر او ارسل {تم}')
elseif msg.content_.ID == "MessageAnimation" then
redis:sadd(veer..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(veer..':ReplayRandom:'..msg.chat_id_..":"..klma,":Animation:"..msg.content_.animation_.animation_.persistent_id_) 
CaptionInsert(msg,msg.content_.animation_.animation_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'🎉︙ تم ادراج المتحركه للرد باقي '..CountRdod..' ✓\n🎉︙ ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageVideo" then
redis:sadd(veer..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(veer..':ReplayRandom:'..msg.chat_id_..":"..klma,":Video:"..msg.content_.video_.video_.persistent_id_) 
CaptionInsert(msg,msg.content_.video_.video_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'🎥︙ تم ادراج الفيديو للرد باقي '..CountRdod..' ✓\n🎥︙ ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageAudio" then
redis:sadd(veer..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(veer..':ReplayRandom:'..msg.chat_id_..":"..klma,":Audio:"..msg.content_.audio_.audio_.persistent_id_) 
CaptionInsert(msg,msg.content_.audio_.audio_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'🎧︙ تم ادراج الصوت للرد باقي '..CountRdod..' ✓\n🎧︙ ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageDocument" then
redis:sadd(veer..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(veer..':ReplayRandom:'..msg.chat_id_..":"..klma,":Document:"..msg.content_.document_.document_.persistent_id_) 
CaptionInsert(msg,msg.content_.document_.document_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'⌔︙ تم ادراج الملف للرد باقي '..CountRdod..' ✓\n⌔︙ ارسل رد اخر او ارسل {تم} .')  
elseif msg.content_.ID == "MessageSticker" then
redis:sadd(veer..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(veer..':ReplayRandom:'..msg.chat_id_..":"..klma,":Sticker:"..msg.content_.sticker_.sticker_.persistent_id_) 
...
redis:hset(veer..'replay:'..msg.chat_id_,klma,msg.text)
...
elseif msg.content_.ID == "MessageDocument" then
redis:hset(veer..'replay_files:group:'..msg.chat_id_,klma,msg.content_.document_.document_.persistent_id_ )
redis:del(veer..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
if msg.content_.caption_ then redis:hset(veer..':caption_replay:'..msg.chat_id_,klma,msg.content_.caption_) end
if msg.text then
redis:del(veer..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
if utf8.len(msg.text) > 4000 then 
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ عذرا غير مسموح باضافه جواب الرد باكثر من 4000 حرف تم الغاء الامر")
end
redis:hset(veer..'replay:all',klma,msg.text)
...
elseif msg.content_.ID == "MessageDocument" then
redis:hset(veer..'replay_files:group:',klma,msg.content_.document_.document_.persistent_id_ )
redis:del(veer..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if msg.Director and (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(veer.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(veer.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_)
redis:set(veer..'linkGroup'..msg.chat_id_,msg.text)
sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم تعيين الرابط بنجاح  ")
return false
end

if msg.Creator and redis:get(veer..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(veer..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_)
redis:set(veer..":infoiduser_public:"..msg.chat_id_,msg.text)
sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم تعيين كليشة الايدي بنجاح \n⌔︙ يمكنك تجربة الامر الان ")
return false
end

if msg.SuperCreator and redis:get(veer..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_) then 

NameUser = redis:get(veer..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_)
UserID = redis:get(veer..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_)
if not msg.text:match("[1234567]") and not msg.text:match("[*]") and not msg.text:match("[*][*]") then
redis:del(veer..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_)
redis:del(veer..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_)
...
redis:sadd(veer..'admins:'..msg.chat_id_,UserID)
local trues = "✓"
local falses = "✖️"
...
.."⌔︙ صلاحيه حظر وتقيد العضوين : "..infochange3.."\n"
...
if msg.Creator and redis:get(veer..":changawmer:"..msg.chat_id_..msg.sender_user_id_) and not redis:get(veer..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
if msg.text=="م1" or msg.text=="م2" or msg.text=="م3" or msg.text=="م4" or msg.text=="م5" or msg.text=="الاوامر" or msg.text=="اوامر الملفات" then return false end
local amr = redis:get(veer..":changawmer:"..msg.chat_id_..msg.sender_user_id_)
if amr == "م1" then
redis:set(veer..":awamer_Klesha_m1:",msg.text)
elseif amr == "م2" then
redis:set(veer..":awamer_Klesha_m2:",msg.text)
elseif amr == "م3" then
redis:set(veer..":awamer_Klesha_m3:",msg.text)
elseif amr == "م4" then
redis:set(veer..":awamer_Klesha_mtwr:",msg.text)
elseif amr == "م5" then
redis:set(veer..":awamer_Klesha_mrd:",msg.text)
elseif amr == "اوامر الملفات" then
redis:set(veer..":awamer_Klesha_mf:",msg.text)
elseif amr == "الاوامر" then
redis:set(veer..":awamer_Klesha_m:",msg.text)
end
redis:del(veer..":changawmer:"..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم تعيين كليشة التعليمات بنجاح \n⌔︙ يمكنك تجربة الامر *{"..amr.."}* ")
end


if msg.SudoUser and redis:get(veer..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(veer..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_)
redis:set(veer..":infoiduser",msg.text)
sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم تعيين كليشة الايدي بنجاح \n⌔︙ يمكنك تجربة الامر الان ")
return false
end
...
if msg.Director and redis:get(veer..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_) then
local Awammer 	= redis:hgetall(veer..":AwamerBotArray2:"..msg.chat_id_)
Amr = redis:get(veer..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_)
checknewamr = false
...
for k, Veer in pairs(XVeer) do 
local cceck,sec = Veer:gsub("[(]"..Amr.."[)]","("..msg.text..")")
print(cceck,sec)
if sec ~= 0 then
redis:hset(veer..":AwamerBotArray:"..msg.chat_id_,cceck,Veer)
redis:hset(veer..":AwamerBotArray2:"..msg.chat_id_,msg.text,Amr)
end
end  
redis:hset(veer..":AwamerBot:"..msg.chat_id_,msg.text,Amr)
sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم تغيير الامر القديم ["..Amr.."] \n⌔︙ الى الامر الجديد ["..msg.text.."]\n...")
end
redis:del(veer..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_)
return false
end

if msg.Director and not redis:get(veer..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) and redis:get(veer..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_) then
local Awammer 	= redis:hgetall(veer..":AwamerBotArray2:"..msg.chat_id_)
local Amr = redis:get(veer..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)
...
redis:del(veer..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)
return false
end

if msg.Director and redis:get(veer..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) then
local checkAmr = false
for k, Veer in pairs(XVeer) do if msg.text:match(Veer) then checkAmr = true end end      
if checkAmr then
sendMsg(msg.chat_id_,msg.id_,"⌔︙ لتغيير الامر {* "..msg.text.." *} \n︙ ارسل الامر الجديد الان \n...")
redis:setex(veer..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_,900,msg.text)
else
sendMsg(msg.chat_id_,msg.id_,"⌔︙ عذرا لا يوجد هذا الامر في البوت لتتمكن من تغييره  \n")
end
redis:del(veer..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_)
return false
end


if msg.SudoUser and msg.text and redis:get(veer..":Witing_DelNewRtba:"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(veer..":Witing_DelNewRtba:"..msg.chat_id_..msg.sender_user_id_)
...
if msg.SudoUser and msg.text and redis:get(veer..":Witing_NewRtba:"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(veer..":Witing_NewRtba:"..msg.chat_id_..msg.sender_user_id_)
...
redis:setex(veer..":Witting_NewRtba2:"..msg.chat_id_..msg.sender_user_id_,1000,msg.text)
sendMsg(msg.chat_id_,msg.id_,"- الان ارسل الرتبه الجديده")
return false
end


if msg.SudoUser and msg.text and redis:get(veer..":Witting_NewRtba2:"..msg.chat_id_..msg.sender_user_id_) then 


local rtbanamenew = redis:get(veer..":Witting_NewRtba2:"..msg.chat_id_..msg.sender_user_id_)
if rtbanamenew == "مطور اساسي" then
redis:set(veer..":RtbaNew1:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "مطور" then
redis:set(veer..":RtbaNew2:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "منشئ اساسي" then
redis:set(veer..":RtbaNew3:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "منشئ" then
redis:set(veer..":RtbaNew4:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "مدير" then
redis:set(veer..":RtbaNew5:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "ادمن" then
redis:set(veer..":RtbaNew6:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "مميز" then
redis:set(veer..":RtbaNew7:"..msg.chat_id_,msg.text)
end
...
if msg.Director and redis:get(veer..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_) then
local checkk = redis:hdel(veer..":AwamerBotArray2:"..msg.chat_id_,msg.text)
...
redis:del(veer..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_)
return false
end
...
local checkk = redis:hdel(veer..":AwamerBot:"..msg.chat_id_,msg.text)
if checkk ~=0 then
tiires =  "⌔︙ تم مسح الامر {* "..msg.text.." *} من قائمه الاومر \n..."
else
tiires = "⌔︙ هذا الامر ليس موجود ضمن الاوامر المضافه  \n"
...
if msg.SudoBase and redis:get(veer..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_) then
...
redis:set(veer..":SUDO_ID:",UserID)
local usero = arg.USERNAME:gsub([[\_]],"_")
redis:hset(veer..'username:'..UserID,'username',usero)
...
redis:del(veer..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_)
return false 
end
...
sendMsg(msg.chat_id_,msg.id_,"⌔︙ المعرف الذي ارسلته ليس معرف قناة.")
return false
...
redis:hdel(veer..'replay_files:group:',msg.text)
...
if redis:get(veer..':KStart:'..msg.chat_id_..msg.sender_user_id_) then
redis:del(veer..':KStart:'..msg.chat_id_..msg.sender_user_id_)
redis:set(veer..':Text_Start',msg.text)
...
local file = redis:hget(veer..'replay_files:group:',msg.text)
...
if redis:get(veer..'welcom:witting'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(veer..'welcom:witting'..msg.chat_id_..msg.sender_user_id_) 
redis:set(veer..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم وضع الترحيب بنجاح كلاتي " )
end
if redis:get(veer..'rulse:witting'..msg.chat_id_..msg.sender_user_id_) then --- استقبال القوانين
redis:del(veer..'rulse:witting'..msg.chat_id_..msg.sender_user_id_) 
redis:set(veer..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'⌔︙ تم حفظ القوانين بنجاح \n⌔︙ ارسل [[ القوانين ]] لعرضها')
end
if redis:get(veer..'name:witting'..msg.chat_id_..msg.sender_user_id_) then --- استقبال الاسم
redis:del(veer..'name:witting'..msg.chat_id_..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(veer..'about:witting'..msg.chat_id_..msg.sender_user_id_) then --- استقبال الوصف
redis:del(veer..'about:witting'..msg.chat_id_..msg.sender_user_id_) 
...
if redis:get(veer..':prod_pin:'..msg.chat_id_..msg.sender_user_id_) then 
redis:del(veer..':prod_pin:'..msg.chat_id_..msg.sender_user_id_)
local groups = redis:smembers(veer..'group:ids')
if #groups >= 300 then
...
if data.chat_id_ then redis:setex(veer..":propin"..data.chat_id_,100,data.content_.text_) end
end)
end
...
if msg.content_.ID == "MessagePhoto" and redis:get(veer..'welcom_ph:witting'..msg.sender_user_id_) then
...
--=============================================================================================================================
if msg.SudoUser and msg.text and redis:get(veer..'addrdRandom1Public:'..msg.chat_id_..msg.sender_user_id_) then 
if not redis:get(veer..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
if utf8.len(msg.text) > 25 then return sendMsg(msg.chat_id_,msg.id_,"⌔︙ عذرا غير مسموح باضافه كلمه الرد باكثر من 25 حرف ") end
redis:setex(veer..'addrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_,1400,true) 
redis:setex(veer..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_,1400,msg.text)
...
if  msg.SudoUser and msg.text and redis:get(veer..':DelrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_) then
redis:del(veer..':DelrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_)
local DelRd = redis:del(veer..':ReplayRandom:'..msg.text) 
if DelRd == 0 then 
return sendMsg(msg.chat_id_,msg.id_,'⌔︙ هذا الرد ليس مضاف في الردود العشوائيه ')
end
redis:del(veer..':caption_replay:Random:'..msg.text) 
redis:srem(veer..':KlmatRRandom:',msg.text) 
...
if redis:get(veer..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(veer..'replay1Random'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
if utf8.len(msg.text) > 25 then 
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ عذرا غير مسموح باضافه كلمه الرد باكثر من 25 حرف ")
end
redis:setex(veer..'addrdRandom:'..msg.chat_id_..msg.sender_user_id_,1400,true) 
redis:setex(veer..'replay1Random'..msg.chat_id_..msg.sender_user_id_,1400,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"⌔︙جيد , يمكنك الان ارسال جواب الرد المتعدد العام \n⌔︙ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه,ملف ]] \n\n علما ان الاختصارات كالاتي : \n \n#name : لوضع اسم العضو\n#id : لوضع ايدي العضو\n#username : لوضع معرف العضو \n#stast : لوضع نوع رتبه العضو \n#auto : لوضع تفاعل العضو \n#msgs : لاضهار عدد الرسائل \n#game : لاضهار عدد النقاط \n#edit : لاضهار عدد السحكات \n#bot : لاضهار اسم البوت\n#sudo : لاضهار معرف المطور الاساسي\n\n〽️| يمكنك اضافه 10 ردود متعدد كحد اقصى  \n➼")
end
end
...
if msg.text and redis:get(veer..':DelrdRandom:'..msg.chat_id_..msg.sender_user_id_) then
redis:del(veer..':DelrdRandom:'..msg.chat_id_..msg.sender_user_id_)
local DelRd = redis:del(veer..':ReplayRandom:'..msg.chat_id_..":"..msg.text) 
if DelRd == 0 then 
return sendMsg(msg.chat_id_,msg.id_,'⌔︙ هذا الرد ليس مضاف في الردود العشوائيه ')
end
redis:del(veer..':caption_replay:Random:'..msg.chat_id_..msg.text) 
redis:srem(veer..':KlmatRRandom:'..msg.chat_id_,msg.text) 
return sendMsg(msg.chat_id_,msg.id_,'⌔︙ تم حذف الرد بنجاح ')
end
...
local files 	= redis:hget(veer..'replay_files:group:'..msg.chat_id_,msg.text)
...
redis:hdel(veer..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(veer..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(veer..'replay_files:group:'..msg.chat_id_,msg.text)
redis:hdel(veer..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(veer..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(veer..'replay_video:group:'..msg.chat_id_,msg.text)
...
if not msg.Director and not msg.OurBot and redis:get(veer..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
welcome = (redis:get(veer..'welcome:msg'..msg.chat_id_) or "⌔︙ نورت المجموعة ")
welcome = welcome:gsub("{القوانين}", redis:get(veer..'rulse:msg'..msg.chat_id_) or "⌔︙ ممنوع نشر الروابط \n⌔︙ ممنوع التكلم او نشر صور اباحيه \n⌔︙ ممنوع  اعاده توجيه \n⌔︙ ممنوع التكلم بلطائفه \n⌔︙ الرجاء احترام المدراء والادمنيه 😅\n")
if msg.addusername then UserName = '@'..msg.addusername else UserName = '< لا يوجد معرف >' end
local edited = (redis:get(veer..':edited:'..msg.chat_id_..':'..msg.adduser) or 0)
local points = redis:get(veer..':User_Points:'..msg.chat_id_..msg.adduser) or 0
local msgs = redis:get(veer..'msgs:'..msg.adduser..':'..msg.chat_id_) or 1

if msg.adduser == SUDO_ID then 
gtupe = 'المطور الاساسي' 
elseif redis:sismember(veer..':SUDO_BOT:',msg.adduser) then 
gtupe = 'المطور'
elseif msg.GroupActive and redis:sismember(veer..':MONSHA_Group:'..msg.chat_id_,msg.adduser) then 
gtupe = 'منشئ اساسي'
elseif msg.GroupActive and redis:sismember(veer..':MONSHA_BOT:'..msg.chat_id_,msg.adduser) then 
gtupe = 'المنشىء'
elseif msg.GroupActive and redis:sismember(veer..'owners:'..msg.chat_id_,msg.adduser) then 
gtupe = 'المدير' 
elseif msg.GroupActive and redis:sismember(veer..'admins:'..msg.chat_id_,msg.adduser) then 
gtupe = 'الادمن'
elseif msg.GroupActive and redis:sismember(veer..'whitelist:'..msg.chat_id_,msg.adduser) then 
gtupe = 'عضو مميز'
...
welcome = welcome:gsub("#Group",Flter_Markdown((redis:get(veer..'group:name'..msg.chat_id_) or '')))
...
local welcome = welcome:gsub("#auto",Get_Ttl(msgs))
local welcome = welcome:gsub("#msgs",msgs)
local welcome = welcome:gsub("#game",points)
local welcome = welcome:gsub("#edit",edited)
local welcome = welcome:gsub("#bot",redis:get(veer..':NameBot:'))
local welcome = welcome:gsub("#sudo",SUDO_USER)
...
if msg.edited and not msg.SuperCreator and redis:get(veer.."antiedit"..msg.chat_id_) then 
...
if #monsha ~= 0 then 
for k,v in pairs(monsha) do
local info = redis:hgetall(veer..'username:'..v) if info and info.username and info.username:match("@[%a%d_]+") then usersmnc = usersmnc..info.username.." - " end
sendMsg(v,0,"⌔︙ هناك شخص قام بالتعديل \n⌔︙ الاسم : ←"..NameUser.." "..uuseri.."\n⌔︙ الايدي : `"..msg.sender_user_id_.."`\n⌔︙ رتبته : "..Getrtba(msg.sender_user_id_,msg.chat_id_).."\n⌔︙ نوع التعديل : "..Rwers.."\n⌔︙ المجموعة : "..Flter_Markdown((redis:get(veer..'group:name'..msg.chat_id_) or '')).."\n⌔︙ الرابط : "..redis:get(veer..'linkGroup'..msg.chat_id_).." " )
end
end
...
SendMention(arg.chat_id_,datau.id_,arg.id_,"⌔︙ العضو » "..USERNAME.."\n⌔︙ قمـت بتكرار اكثر مـن "..arg.NUM_MSG_MAX.." رسـاله‌‏ , لذا تم تقييدك مـن المـجمـوعه‌‏ ✓\n",12,utf8.len(USERNAME)) 
...
return false
elseif (msg.text:match("ه‍") or msg.text:match("ی") or msg.text:match("ک")) and redis:get(veer.."lock_pharsi"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif KlmatMmno3(msg.text) and redis:get(veer.."lock_mmno3"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("[a-zA-Z]") and redis:get(veer.."lock_lang"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#.+") and redis:get(veer..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(veer.."lock_RandomRdod"..msg.chat_id_) then 
local Replay = 0
Replay = redis:smembers(veer..':ReplayRandom:'..msg.text) 
if #Replay ~= 0 then 
...
Caption = redis:hget(veer..':caption_replay:Random:'..msg.text,CaptionFilter)
...
local Replay = 0
Replay = redis:smembers(veer..':ReplayRandom:'..msg.chat_id_..":"..msg.text) 
if #Replay ~= 0 then 
local Replay = Replay[math.random(#Replay)]
Replay = convert_Klmat(msg,data,Replay,true)
local CaptionFilter = Replay:gsub(":Text:",""):gsub(":Document:",""):gsub(":Voice:",""):gsub(":Photo:",""):gsub(":Animation:",""):gsub(":Audio:",""):gsub(":Sticker:",""):gsub(":Video:","")
Caption = redis:hget(veer..':caption_replay:Random:'..msg.chat_id_..msg.text,CaptionFilter)
Caption = convert_Klmat(msg,data,Caption)
if Replay:match(":Text:") then
return sendMsg(msg.chat_id_,msg.id_,Flter_Markdown(Replay:gsub(":Text:","")))
elseif Replay:match(":Document:") then 
...
Replay = redis:hget(veer..'replay_files:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(veer..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(veer..'replay_files:group:',msg.text)
if Replay then 
Caption = redis:hget(veer..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendDocument(msg.chat_id_,msg.id_,Replay,Caption)  
...
if msg.text and redis:get(veer.."lock_rdodSource"..msg.chat_id_) then
...
"اي مو كدامك مغني قديم 😒🎋 هوه ﴿↜ انـِۨـۛـِۨـۛـِۨيـُِـٌِہۧۥۛ ֆᵛ͢ᵎᵖ ⌯﴾❥  ربي كامز و تكلي غنيلي 🙄😒🕷 اإرۈحُـ✯ـہ✟  😴أنــ💤ــااااام😴  اشرف تالي وكت يردوني اغني 😒☹️🚶","لا تظربني لا تظرب 💃💃 كسرت الخيزارانه💃🎋 صارلي سنه وست اشهر💃💃 من ظربتك وجعانه🤒😹",
