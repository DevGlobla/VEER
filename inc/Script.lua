...
if not msg.SudoUser then return '⌔︙لتفعيل حماية بوت بباي \n⌔︙عليك مراسلة مطور البوت @YYBYY'end
...
return '⌔︙ اصدار سورس بباي : *v'..version..'*'
end
...
sendMsg(arg.chat_id_,arg.id_,'⌔︙ عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس بباي يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم')
end  
else
...
local inline = {{{text="قناه السـورس : بباي 🍃",url="t.me/l6l_ch"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : بباي](t.me/l6l_ch)',nil,inline,msg.id_)
return false
end
