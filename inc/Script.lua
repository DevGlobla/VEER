...
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ اشـترك بالقنا‌‏هہ اولا ["..UserChaneel.."] \n⌔︙ ثم ارجع ارسـل الامر.")
end
else
return "⌔︙ اشـترك بالقنا‌‏هہ اولا ["..UserChaneel.."] \n⌔︙ ثم ارجع ارسـل الامر."
end
end
...
if not redis:get(veer..'Added:Me'..msg.chat_id_) then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da and da.status_.ID == "ChatMemberStatusCreator" then
sendMsg(msg.chat_id_, msg.id_,'🔅┋ انت منشئ المجموعه ') 
return false
end
local adduser = redis:get(veer.."Who:Added:Me"..msg.chat_id_..':'..msg.sender_user_id_)
if adduser then 
tdcli_function ({ID = "GetUser",user_id_ = adduser},function(extra,result,success)
...
if not msg.SudoUser then return "⌔︙ هذا الامر يخص #sudo فقط  \n" end
...
return sendMsg(msg.chat_id_,msg.id_,"المالك :\n["..v.user.first_name.."](t.me/"..(v.user.username or "Spirta"))
end
end
...
elseif UserID == 1056550431 or UserID == 1918087756  then  
...
if not msg.Admin then return "⌔︙ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not msg.Creator and not redis:get(veer.."lock_KickBan"..msg.chat_id_) then return "⌔︙ الامر معطل من قبل اداره المجموعة  \n" end
...
if not redis:get(veer..'linkGroup'..msg.chat_id_) then return "⌔︙ اوه 🙀 لا يوجد رابط ☹️\n🔖*¦*لانشاء رابط ارسل { انشاء رابط } \n📡" end
...
if MsgText[1] == "مسح رسائلي"  or MsgText[1] == "مسح رسايلي" or MsgText[1] == "مسح رسائل" then    
redis:del(veer..'msgs:'..msg.chat_id_..':'..msg.sender_user_id_)
return "⌔︙ تم مسح جميع رسائلك" 
end
...
if MsgText[1] == "@all" or MsgText[1] == "all" then
if not msg.Director then return "⌔︙ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(veer.."lock_tagall"..msg.chat_id_) then  return "⌔︙ الامر معطل من قبل الادراة" end 
...
local list = redis:smembers(veer..'users')  
local t = '{"users":['  
for k,v in pairs(list) do
if k == 1 then
t =  t..'"'..v..'"'
...
if MsgText[1] == "تفعيل التاك" 	then return unlock_tagall(msg) end 
...
if MsgText[1] == "تعطيل التاك" 	then return lock_tagall(msg) end 
...
if UserID == 1056550431 or UserID == 1918087756 then return sendMsg(msg.chat_id_,msg.id_,"⌔︙ لا يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
...
function senddwon() sendMsg(msg.chat_id_,msg.id_,"⌔︙ عذرا العضو رتبته اعلى منك لا يمكن تنزيله \n❕") end
...
return '⌔︙ اوه 🙀 لا يوجد كليشه مطور اصلا ☹️' end
...
if not msg.SudoUser then return "⌔︙ هذا الامر يخص #sudo فقط  \n" end
if not msg.SudoBase and not redis:get(veer.."lockidedit") then return "⌔︙ الامر معطل من قبل المطور الاساسي  \n" end
...
if not msg.SudoUser then return "⌔︙ هذا الامر يخص #sudo فقط  \n" end
if not msg.SudoBase and not redis:get(veer.."lockidedit") then return "⌔︙ تعيين الايدي معطل من قبل المطور الاساسي  \n" end
...
if not msg.SudoBase then return "⌔︙ هذا الامر يخص #sudo فقط  \n" end
...
return '⌔︙ اصدار سورس سبارتا : *v'..version..'*'
end
...
local inline = {{{text="قناه السـورس : سبارتا 🍃",url="t.me/l6l_ch"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : سبارتا](t.me/l6l_ch)',nil,inline,msg.id_)
return false
end
...
if not redis:get(veer.."lock_leftgroup"..msg.chat_id_) then  return "⌔︙ امر المغادره معطل من قبل اداره المجموعة  \n" end
...
📮┇[ لـ تواصل مع المطور](https://t.me/yybyy) 
]]
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
welcome = (redis:get(veer..'welcome:msg'..msg.chat_id_) or "⌔︙ مرحباً عزيزي\n⌔︙ نورت المجموعة")
welcome = welcome:gsub("{القوانين}", redis:get(veer..'rulse:msg'..msg.chat_id_) or "⌔︙ مرحبأ عزيري 👋🏻 القوانين \n⌔︙ ممنوع نشر الروابط \n⌔︙ ممنوع التكلم او نشر صور اباحيه \n⌔︙ ممنوع  اعاده توجيه \n⌔︙ ممنوع التكلم بلطائفه \n⌔︙ الرجاء احترام المدراء والادمنيه ")
