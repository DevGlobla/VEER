...
local points = (redis:get(veer..':points:'..arg.chat_id_..':'..arg.sender_user_id_) or 0)

local KleshaID = '⌔︙ ايديــك ← {'..arg.sender_user_id_..'} \n'..arg.UserNameID..'⌔︙ رتبتـــك ← '..arg.TheRank..' \n'..'⌔︙ تفاعـلك ← '..Get_Ttl(arg.msgs)..'\n'..'⌔︙ رسائلك ← {'..arg.msgs..'}\n⌔︙ سحكاتك ← {'..edited..'}'..' \n⌔︙نقاطك ←('..points..')'..'\n⌔︙ الانضمام ← '..os.date("%Y/%m/%d")..' \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'
...
return '⌔︙ اصدار سورس البباي : *v'..version..'*'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس ™') then
if not msg.SudoBase then return "⌔︙ هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://Spirta.github.io/GetVersion.txt') or "0"
...
sendMsg(arg.chat_id_,arg.id_,'⌔︙ عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس البباي يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم')
end  
else
...
local inline = {{{text="قناه السـورس : بباي 🍃",url="t.me/Spirta"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : بباي](t.me/Spirta)',nil,inline,msg.id_)
return false
end
...
if not msg.SudoBase then return "⌔︙ هذا الامر يخص {المطور الاساسي} فقط  \n" end
local Get_Files, res = https.request("https://Spirta.github.io/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/TH3BS/Spirta.github.io/master/plugins/"..FileName)
if res == 200 then
