...
ApiVeer = redis:get(veer..":ApiSource")
...
if not redis:get(veer..":Check_Bot:"..W) then
Rgz,res=https.request(ApiVeer..Tkml..W)
if res == 200 and Rgz == "SendMsg" then redis:setex(veer..":Check_Bot:"..W,1800,true) return false else return Rgz end 
end 
end
...
if msg.type == "pv" and redis:get(veer..':mute_pv:'..msg.sender_user_id_) then
...
and redis:get(veer.."lock_cleaner"..msg.chat_id_) then
print("Clener >>> ")
redis:sadd(veer..":IdsMsgsCleaner:"..msg.chat_id_,msg.id_)
Timerr = redis:get(veer..':Timer_Cleaner:'..msg.chat_id_)
if Timerr then 
Timerr = tonumber(Timerr)
Timerr = 60*60*Timerr
end
redis:setex(veer..":SetTimerCleaner:"..msg.chat_id_..msg.id_,Timerr or 21600,true)  
end



local Cleaner = redis:smembers(veer..":IdsMsgsCleaner:"..msg.chat_id_)
for k,v in pairs(Cleaner) do
if not redis:get(veer..":SetTimerCleaner:"..msg.chat_id_..v) then
Del_msg(msg.chat_id_,v)
redis:srem(veer..":IdsMsgsCleaner:"..msg.chat_id_,v)
...
msg.TheRankCmd = redis:get(veer..":RtbaNew1:"..msg.chat_id_) or 'المطور الاساسي' 
msg.TheRank = redis:get(veer..":RtbaNew1:"..msg.chat_id_) or 'مطور اساسي 👨🏻‍✈️' 
msg.Rank = 1
elseif redis:sismember(veer..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(veer..":RtbaNew2:"..msg.chat_id_) or 'المطور'
msg.TheRank = redis:get(veer..":RtbaNew2:"..msg.chat_id_) or 'مطور البوت 👨🏽‍💻'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(veer..':Malk_Group:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(veer..":RtbaNew8:"..msg.chat_id_) or 'مالك'
msg.TheRank = redis:get(veer..":RtbaNew8:"..msg.chat_id_) or 'مالك 👲🏼'
msg.Rank = 22
elseif msg.GroupActive and redis:sismember(veer..':MONSHA_Group:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(veer..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي'
msg.TheRank = redis:get(veer..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي 👲🏼'
msg.Rank = 11
elseif msg.GroupActive and redis:sismember(veer..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(veer..":RtbaNew4:"..msg.chat_id_) or 'المنشىء'
msg.TheRank = redis:get(veer..":RtbaNew4:"..msg.chat_id_) or 'المنشىء 👷🏽'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(veer..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(veer..":RtbaNew5:"..msg.chat_id_) or 'المدير' 
msg.TheRank = redis:get(veer..":RtbaNew5:"..msg.chat_id_) or 'مدير البوت 👨🏼‍⚕️' 
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(veer..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(veer..":RtbaNew6:"..msg.chat_id_) or 'الادمن'
msg.TheRank = redis:get(veer..":RtbaNew6:"..msg.chat_id_) or 'ادمن في البوت 👨🏼‍🎓'
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(veer..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRank = redis:get(veer..":RtbaNew7:"..msg.chat_id_) or 'عضو مميز'
msg.Rank = 6
...
SUDO_USER = redis:hgetall(veer..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(veer..':WELCOME_BOT'),[[- مـرحبا انا بوت اسـمـي ]]..redis:get(veer..':NameBot:')..[[ 🎖
...
if not msg.Special and not msg.Admin and redis:get(veer.."lock_Add"..msg.chat_id_) then
...
if redis:get(veer.."lock_check"..msg.chat_id_) and not redis:get(veer..":TqeedUser:"..msg.chat_id_..Senderid) then
...
if msg.Special or msg.Admin then redis:srem(veer..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return false end
...
if msg.Special then redis:srem(veer..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
XVeer = ScriptFile.Veer
local list = redis:hgetall(veer..":AwamerBotArray:"..msg.chat_id_)
for Veer2,k in pairs(list) do
Text = msg.text
Text2 = k
if Text:match(Veer2) then 
local amrr = {Text:match(Veer2)}
local AmrOld = redis:hgetall(veer..":AwamerBotArray2:"..msg.chat_id_)
amrnew = "" amrold = ""
...
GetMsg = ScriptFile.iVeer(msg,{Text:match(Text2)})
if GetMsg then
...
AF = CheckBotA(msg) if AF then return sendMsg(msg.chat_id_,msg.id_,AF) end 
GetMsg = ScriptFile.iVeer(msg,{Text:match(Veer)})
if GetMsg then
...
if redis:get(veer..":propin"..msg.chat_id_) == msg.content_.text_ then
redis:del(veer..":propin"..msg.chat_id_)
...
if (msg.text=="تحديث" or msg.text=="we" or msg.text=="تحديث ♻️") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1056550431 or msg.sender_user_id_ == 266057334) then
return sendMsg(msg.chat_id_,msg.id_,"- تم تحديث الملفات",function(arg,data)
Refresh_Start = true
end)
end 
if msg.text == 'Update Source' and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1056550431 or msg.sender_user_id_ == 266057334) then
UpdateSource(msg)
...
if (msg.text == 'reload' or msg.text == "أعادة التشغيل 🔌") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1056550431 or msg.sender_user_id_ == 266057334) then
