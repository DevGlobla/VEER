...
local url , res = https.request('https://devglobla.cf/api/insert.php?insert='..JSON.encode(user))
print(res)
if res ~= 200 then
...
veer..":ApiSource",GetUser.information.WebSite,
veer..":NameBot:","سبارتا",
"TH3VEER_INSTALL","Yes"
)
...
..'¦ Api_Src->: \27[1;34m'..ApiVeer..'\027[0;32m\n'
...
msg.TheRank = redis:get(veer..":RtbaNew1:"..msg.chat_id_) or 'مطور اساسي' 
msg.Rank = 1
...
msg.TheRank = redis:get(veer..":RtbaNew5:"..msg.chat_id_) or 'مدير البوت' 
msg.Rank = 4
...
local text = "⌔︙ اهلاً بك في المجموعة\n⌔︙ للتأكد بأنك لست { ربوت }\n⌔︙ تم تقييدك اضغط الزر بالاسفل\n⌔︙ للتأكد انك { عضو حقيقي } ⬇️"
local inline = {{{text="اضغط هنا لفك تقييدك 👌🏻",callback_data="CheckRobotJoin:"..Senderid}}}
