...
print(CmdSitting)
if CmdSitting then
local ResRedis =  redis:del(veer..CmdSitting..msg.chat_id_)
...
if not CheckUserAdmin(msg) then return answerCallbackQuery(data.id_,"ليس لديك صلاحية التحكم الادمن , ارجو المعذرة ❤️",true) end
if ResRedis == 0 then redis:set(veer..CmdSitting..msg.chat_id_,true) end
...
list_settings = '{"inline_keyboard": ['
..'[{"text": " التعديل » '..(redis:get(veer..'lock_edit'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_edit"},'
..'{"text": " الروابط » '..(redis:get(veer..'lock_link'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_link"}],'

..'[{"text": " التاك » '..(redis:get(veer..'lock_tag'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_tag"},'
..'{"text": " المعرفات » '..(redis:get(veer..'lock_username'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_username"}],'

..'[{"text": " التكرار » '..(redis:get(veer..'lock_flood'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_flood"},'
..'{"text": " الكلايش » '..(redis:get(veer..'lock_spam'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_spam"}],'

..'[{"text": " الويب » '..(redis:get(veer..'lock_webpage'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_webpage"},'
..'{"text": " الماركدوان » '..(redis:get(veer..'lock_markdown'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_markdown"}],'

..'[{"text": " البوتات بالطرد » '..(redis:get(veer..'lock_bots_by_kick'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_bots_by_kick"},'
..'{"text": " البوتات » '..(redis:get(veer..'lock_bots'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_bots"}],'

..'[{"text": " الاضافه » '..(redis:get(veer..'lock_Add'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_Add"},'
..'{"text": " الاشعارات » '..(redis:get(veer..'mute_tgservice'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#mute_tgservice"}],'

..'[{"text": " الفشار » '..(redis:get(veer..'lock_mmno3'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_mmno3"},'
..'{"text": " الفارسيه » '..(redis:get(veer..'lock_pharsi'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_pharsi"}],'

..'[{"text": " الانكليزيه » '..(redis:get(veer..'lock_lang'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_lang"},'
..'{"text": " التوجيه » '..(redis:get(veer..'mute_forward'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#mute_forward"}],'
...
list_settings = '{"inline_keyboard": ['
..'[{"text": " المتحركه » '..(redis:get(veer..'mute_gif'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_gif"},'
..'{"text": " الدردشه » '..(redis:get(veer..'mute_text'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_text"}],'

..'[{"text": " الانلاين » '..(redis:get(veer..'mute_inline'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_inline"},'
..'{"text": " الالعاب » '..(redis:get(veer..'mute_game'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_game"}],'

..'[{"text": " الصور » '..(redis:get(veer..'mute_photo'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_photo"},'
..'{"text": " الفيديو » '..(redis:get(veer..'mute_video'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_video"}],'

..'[{"text": " الصوت » '..(redis:get(veer..'mute_audio'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_audio"},'
..'{"text": " البصمات » '..(redis:get(veer..'mute_voice'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_voice"}],'

..'[{"text": " الملصقات » '..(redis:get(veer..'mute_sticker'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_sticker"},'
..'{"text": " الجهات » '..(redis:get(veer..'mute_contact'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_contact"}],'

..'[{"text": " الموقع » '..(redis:get(veer..'mute_location'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_location"},'
..'{"text": " الملفات » '..(redis:get(veer..'mute_document'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_document"}],'
..'[{"text": "- رجوع » ","callback_data": "CmdBack1"},{"text": "- اخفاء الامر","callback_data": "LoginOut"}]'
...
list_settings = '{"inline_keyboard": ['
..'[{"text": " الايدي » '..(redis:get(veer..'lock_id'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_id"},'
..'{"text": " التاك للكل » '..(redis:get(veer..'lock_takkl'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_takkl"}],'

..'[{"text": " الترحيب » '..(redis:get(veer..'welcome:get'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#welcome:get"},'
..'{"text": " الردود » '..(redis:get(veer..'replay'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#replay"}],'

..'[{"text": " الردود العشوائيه » '..(redis:get(veer..'lock_tag'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_tag"},'
..'{"text": " التحذير » '..(redis:get(veer..'lock_woring'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_woring"}],'

..'[{"text": " تاك » '..(redis:get(veer..'lock_RandomRdod'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_RandomRdod"},'
..'{"text": " الرابط » '..(redis:get(veer..'lock_linkk'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_linkk"}],'

..'[{"text": " المغادره » '..(redis:get(veer..'lock_leftgroup'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_leftgroup"},'
..'{"text": " الحظر » '..(redis:get(veer..'lock_KickBan'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_KickBan"}],'

..'[{"text": " الحمايه » '..(redis:get(veer..'antiedit'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#antiedit"},'
..'{"text": " الايدي بالصوره » '..(redis:get(veer..'idphoto'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#idphoto"}],'

..'[{"text": " التحقق » '..(redis:get(veer..'lock_check'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_check"},'
..'{"text": " التنظيف التلقائي » '..(redis:get(veer..'lock_cleaner'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_cleaner"}],'
...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1056550431 or msg.sender_user_id_ == 266057334 then 
Adminn = true
elseif redis:sismember(veer..':SUDO_BOT:',msg.sender_user_id_) then 
Adminn = true
elseif redis:sismember(veer..':Malk_Group:'..msg.chat_id_,msg.sender_user_id_) then 
Adminn = true
elseif redis:sismember(veer..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
Adminn = true
elseif redis:sismember(veer..':MONSHA_Group:'..msg.chat_id_,msg.sender_user_id_) then 
Adminn = true
elseif redis:sismember(veer..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
Adminn = true
elseif redis:sismember(veer..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
Adminn = true
end
return Adminn 
end
...
download_file('https://raw.githubusercontent.com/Spirta/VEER/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/Spirta/VEER/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/Spirta/VEER/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/Spirta/VEER/master/inc/functions.lua','./inc/functions.lua')
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(veer..":NameBot:") or "الزعيم"
...
Fshar_Word , res = https.request('https://api.th3veer.com/Words_Fshars.txt')
...
result = false
if msg.sender_user_id_ == 1056550431 or msg.sender_user_id_ == 266057334 then 
SudoBase = true
...
var = redis:get(veer..":RtbaNew1:"..ChatID) or 'مطور اساسي 👨🏻‍✈️' 
elseif redis:sismember(veer..':SUDO_BOT:',UserID) then
var = redis:get(veer..":RtbaNew2:"..ChatID) or 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(veer..':MONSHA_Group:'..ChatID,UserID) then
var = redis:get(veer..":RtbaNew3:"..ChatID) or ' المنشىء اساسي👷🏽' 
elseif redis:sismember(veer..':Malk_Group:'..ChatID,UserID) then
var = redis:get(veer..":RtbaNew8:"..ChatID) or ' المالك 👷🏽' 
elseif redis:sismember(veer..':MONSHA_BOT:'..ChatID,UserID) then
var = redis:get(veer..":RtbaNew4:"..ChatID) or ' المنشىء 👷🏽' 
elseif redis:sismember(veer..'owners:'..ChatID,UserID) then
var = redis:get(veer..":RtbaNew5:"..ChatID) or 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(veer..'admins:'..ChatID,UserID) then
var = redis:get(veer..":RtbaNew6:"..ChatID) or 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(veer..'whitelist:'..ChatID,UserID) then
var = redis:get(veer..":RtbaNew7:"..ChatID) or 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
return var
...
Replay = Replay:gsub("{البوت}",redis:get(veer..':NameBot:'))
...
local monshaas = redis:smembers(veer..':MONSHA_Group:'..msg.chat_id_)
local monsha = redis:smembers(veer..':MONSHA_BOT:'..msg.chat_id_)
local Owners = redis:smembers(veer..'owners:'..msg.chat_id_)
local Admins = redis:smembers(veer..'admins:'..msg.chat_id_)
local mmez = redis:smembers(veer..'whitelist:'..msg.chat_id_)
...
local list = redis:smembers(veer..':Malk_Group:'..msg.chat_id_)
if #list == 0 then  
...
local res = https.request("http://api.th3veer.com/CheckUser/?User="..User)
...
local list = redis:smembers(veer..'bannedpv')
if #list==0 then return "- قائمة المحظورين فارغة " end
message = '-قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
local info = redis:hgetall(veer..'username:'..v)
...
veer..':MONSHA_Group:'..id_group,
veer..':Malk_Group:'..id_group
)
...
if redis:get(veer..'group:add'..msg.chat_id_) then  return sendMsg(msg.chat_id_,msg.id_,'- المجموعه بالتاكيد ✓️ تم تفعيلها \n- بواسطه ⋙「 '..NameUser..' 」 \n') end
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(veer..'username:'..data.id_,'username', ResolveUserName(data))
redis:sadd(veer..':Malk_Group:'..arg.chat_id_,data.id_)
...
veer..'lock_rdodSource'..arg.chat_id_,true,
veer.."lock_KickBan"..msg.chat_id_,true,
veer.."lock_mmno3"..msg.chat_id_,true,
veer.."lock_KickBan"..msg.chat_id_,true,
veer.."lock_RandomRdod"..msg.chat_id_,true,
veer.."lock_linkk"..msg.chat_id_,true
)
...
if cmd == "Upmonsh" then
if redis:sismember(veer..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه منشئ اساسي  في المجموعه ✓") 
end
redis:hset(veer..'username:'..UserID,'username',USERNAME)
redis:sadd(veer..':MONSHA_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه منشئ اساسي  في المجموعه ✓") 
end

if cmd == "Dwmonsh" then
if not redis:sismember(veer..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله منشئ اساسي  في المجموعه ✓") 
end
redis:srem(veer..':MONSHA_Group:'..ChatID,UserID) 
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله منشئ اساسي  في المجموعه ✓") 
end


if cmd == "UpMalk" then
if redis:sismember(veer..':Malk_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه مالك  في المجموعه ✓") 
end
redis:hset(veer..'username:'..UserID,'username',USERNAME)
redis:sadd(veer..':Malk_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه مالك  في المجموعه ✓") 
end

if cmd == "DwnMalk" then
if not redis:sismember(veer..':Malk_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله مالك  في المجموعه ✓") 
end
redis:srem(veer..':Malk_Group:'..ChatID,UserID) 
...
if cmd == "upMshrf" then
redis:hset(veer..'username:'..UserID,'username',Resolv)
redis:setex(veer..":uploadingsomeon:"..ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(veer..":uploadingsomeon2:"..ChatID..msg.sender_user_id_,500,UserID)
...
local edited = redis:get(veer..':edited:'..ChatID..':'..UserID) or 0
local content = redis:get(veer..':adduser:'..ChatID..':'..UserID) or 0
if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end  
...
if UserID == 1056550431 or UserID == 266057334 then return sendMsg(ChatID,MsgID,"- لا يمكنك تنفيذ الامر ضد مطور السورس ❕") end
...
.."\n- التاك » "..(redis:get(veer..'lock_tag'..msg.chat_id_) or 'false')
...
.."\n- الماركدوان » "..(redis:get(veer..'lock_markdown'..msg.chat_id_) or 'false')
...
.."\n- وقت التنظيف » "..(redis:get(veer..':Timer_Cleaner:'..msg.chat_id_) or '6').." ساعة ."
.."\n\n-` اعدادات الوسائط :`\n"
.."\n- المتحركه » "..(redis:get(veer..'mute_gif'..msg.chat_id_) or 'false')
.."\n- الدردشه » "..(redis:get(veer..'mute_text'..msg.chat_id_) or 'false')
.."\n- الانلاين » "..(redis:get(veer..'mute_inline'..msg.chat_id_) or 'false')
...
.."\n- الصوت » "..(redis:get(veer..'mute_audio'..msg.chat_id_) or 'false')
.."\n\n- البصمات » "..(redis:get(veer..'mute_voice'..msg.chat_id_) or 'false')
...
.."\n- الفشار » "..(redis:get(veer..'lock_mmno3'..msg.chat_id_) or 'false')
.."\n- الفارسيه » "..(redis:get(veer..'lock_pharsi'..msg.chat_id_) or 'false')
.."\n- الانكليزيه » "..(redis:get(veer..'lock_lang'..msg.chat_id_) or 'false')
.."\n- الاضافه » "..(redis:get(veer..'lock_Add'..msg.chat_id_) or 'false')

local eueuf = "\n\n-` اعدادات اخرى : `"
.."\n- الترحيب » "..(redis:get(veer..'welcome:get'..msg.chat_id_) or 'false')
.."\n-  الردود » "..(redis:get(veer..'replay'..msg.chat_id_) or 'false')
.."\n-  الردود العشوائيه » "..(redis:get(veer.."lock_RandomRdod"..msg.chat_id_) or 'false')
.."\n-  التحذير » "..(redis:get(veer..'lock_woring'..msg.chat_id_) or 'false')
.."\n- الايدي » "..(redis:get(veer..'lock_id'..msg.chat_id_) or 'false')
.."\n- الرابط » "..(redis:get(veer..'lock_linkk'..msg.chat_id_) or 'false')
.."\n- المغادره » "..(redis:get(veer..'lock_leftgroup'..msg.chat_id_) or 'false')
.."\n- الحظر » "..(redis:get(veer..'lock_KickBan'..msg.chat_id_) or 'false')
.."\n- الحمايه » "..(redis:get(veer..'antiedit'..msg.chat_id_) or 'false')
.."\n- التاك للكل » "..(redis:get(veer..'lock_takkl'..msg.chat_id_) or 'false')
.."\n- الايدي بالصوره » "..(redis:get(veer..'idphoto'..msg.chat_id_) or 'false')
.."\n- التحقق » "..(redis:get(veer.."lock_check"..msg.chat_id_) or 'false')
.."\n- التنظيف التلقائي » "..(redis:get(veer.."lock_cleaner"..msg.chat_id_) or 'false')
.."\n- ردود السورس » "..(redis:get(veer.."lock_rdodSource"..msg.chat_id_) or 'false')
