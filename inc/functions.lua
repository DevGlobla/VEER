...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(veer..":NameBot:") or "الفير"
...
message = message ..i.. '-l ['..info.username..'](t.me/Spirta) \n'
end
...
message = message ..k.. '-l ['..info.username..'](t.me/Spirta) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
message = message ..k.. '-l ['..info.username..'](t.me/Spirta) l » (`' ..v.. '`) \n'
end
end
end
...
if not msg.SudoUser and not lock_servicez then return '⌔︙لتفعيل حماية بوت سبارتا \n⌔︙عليك مراسلة مطور البوت @YYBYY' end
...
if UserID == 1056550431 or UserID == 1918087756 then return sendMsg(ChatID,MsgID,"⌔︙ لا يمكنك تنفيذ الامر ضد مطور السورس ") end
