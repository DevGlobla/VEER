...
download_file('https://raw.githubusercontent.com/TH3BS/VEER/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/TH3BS/VEER/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/TH3BS/VEER/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/TH3BS/VEER/master/inc/functions.lua','./inc/functions.lua')
...
if UserID == 1056550431 or UserID == 190175311 then return sendMsg(ChatID,MsgID,"⌔︙ لا يمكنك تنفيذ الامر ضد مطور السورس ") end
