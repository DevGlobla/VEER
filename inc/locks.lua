...
else redis:set(veer.."lock_RandomRdod"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(veer.."lock_RandomRdod"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد تعطيل الردود العشوائيه    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else redis:del(veer.."lock_RandomRdod"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(veer.."lock_KickBan"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد تفعيل الحظر والطرد    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else redis:set(veer.."lock_KickBan"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(veer.."lock_KickBan"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد تعطيل الحظر والطرد    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else redis:del(veer.."lock_KickBan"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(veer.."lock_rdodSource"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد تفعيل ردود السورس    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else redis:set(veer.."lock_rdodSource"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(veer.."lock_rdodSource"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد تعطيل  ردود السورس    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else redis:del(veer.."lock_rdodSource"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(veer.."lock_check"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد تعطيل التحقق    \n⌔︙ بواسطه ←"..NameUser.." " )        else 
redis:del(veer.."lock_check"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(veer.."lock_check"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد تفعيل التحقق    \n⌔︙ بواسطه ←"..NameUser.." " )        else
redis:set(veer.."lock_check"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(veer.."lock_cleaner"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد تفعيل التنظيف التلقائي    \n⌔︙ بواسطه ←"..NameUser.." " )        else
redis:set(veer.."lock_cleaner"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(veer.."lock_takkl"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد تفعيل تاك للكل    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else redis:set(veer.."lock_takkl"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(veer.."lock_takkl"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد تعطيل تاك للكل    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else
redis:del(veer.."lock_takkl"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(veer.."lock_leftgroup"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد تفعيل المغادره    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else redis:set(veer.."lock_leftgroup"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(veer.."lock_leftgroup"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد تعطيل المغادره    \n⌔︙ بواسطه ←"..NameUser.." " )
else
redis:del(veer.."lock_leftgroup"..msg.chat_id_) 
...
if not msg.SuperCreator then return "هذا الامر يخص المنشئين الاساسين فما فوق فقط  " end
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(veer.."antiedit"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد تفعيل الحمايه    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else redis:set(veer.."antiedit"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(veer.."antiedit"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد تعطيل الحمايه    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else
redis:del(veer.."antiedit"..msg.chat_id_) 
...
else redis:set(veer.."idphoto"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(veer.."idphoto"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد تعطيل الايدي بالصوره    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else
redis:del(veer.."idphoto"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(veer.."lock_linkk"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد تفعيل الرابط    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else redis:set(veer.."lock_linkk"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(veer.."lock_linkk"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد تعطيل الرابط    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else
redis:del(veer.."lock_linkk"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(veer.."lock_mmno3"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد قفل الفشار    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else
redis:set(veer.."lock_mmno3"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(veer.."lock_mmno3"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد فتح الفشار    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else 
redis:del(veer.."lock_mmno3"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(veer.."lock_pharsi"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد قفل الفارسيه    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else
redis:set(veer.."lock_pharsi"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(veer.."lock_pharsi"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد فتح الفارسيه    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else 
redis:del(veer.."lock_pharsi"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(veer.."lock_lang"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد قفل الانكليزيه    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else
redis:set(veer.."lock_lang"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(veer.."lock_lang"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد فتح الانكليزيه    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else 
redis:del(veer.."lock_lang"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(veer.."lock_Add"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد قفل الاضافه    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else
redis:set(veer.."lock_Add"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(veer.."lock_Add"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"⌔︙ تم بالتأكيد فتح الاضافه    \n⌔︙ بواسطه ←"..NameUser.." " ) 
else 
redis:del(veer.."lock_Add"..msg.chat_id_)
